...
const upcomingAppointments = [
  ...
  {
    id: "2",
    pharmacyName: "Farmácia de Santo António",
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Rectangle%20767-VR7jOvQ24dE0sHDsUMLDa3mxdeYv7o.png",
    date: "Segunda 28/Julho",
    time: "09:00 - 10:00",
  },
...
const historyOrders = Array.from({ length: 9 }, (_, i) => ({
  id: `history-${i + 1}`,
  pharmacyName: "Nome da farmácia",
  image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Rectangle%20767-VR7jOvQ24dE0sHDsUMLDa3mxdeYv7o.png",
  date: "Segunda 28/Julho",
  value: "100 MZN",
}))
            ...
            <div key={appointment.id} className="flex-shrink-0 w-80 bg-white border border-system-6 rounded-lg p-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div className="flex-1">
                  <h3 className="font-medium text-sm">{appointment.pharmacyName}</h3>
                </div>
      ...
      <section className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {pendingRequests.map((request) => (
            <Link
              key={request.id}
              href={`/pedidos/cotacoes/${request.id}`}
      ...
      <section className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          {getCurrentPageItems().map((order) => (
            <Link
              key={order.id}
              href={`/pedidos/historico/${order.id}`}
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="font-medium text-sm">{order.pharmacyName}</h3>
                </div>
                <ChevronDownIcon className="w-4 h-4 text-system-10 rotate-[-90deg]" />
              </div>
