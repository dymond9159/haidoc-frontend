  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex justify-between items-start mb-6">
        <BackButton text={`Recibo ${receipt?.number}`} onClick={() => router.back()} />
        <DropdownMenu>
        ...
        <div className="space-y-8">
          <div>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <p className="text-sm text-system-9 mb-1">Método de pagamento</p>
          ...
          <div className="flex flex-col items-center pt-4 border-t border-system-5">
            <p className="text-sm text-system-9 text-center">Informamos que o valor foi recebido pelo emitente.</p>
          </div>
        </div>
      </div>
