...
export default function DetailedActivitiesClient({ activityId }: DetailedActivitiesClientProps) {
  ...
  const handleViewDocument = (documentName: string, type: "before" | "after") => {
    console.log(`Request to view ${type} document: ${documentName} for user ${activityId}`)
