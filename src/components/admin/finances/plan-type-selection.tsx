...
export function PlanTypeSelection({ onSelect, onBack }: PlanTypeSelectionProps) {
    ...
    <div>
      ...
      <Card className="border-system-5">
        <CardContent className="pt-6">
          ...
          <p className="text-sm text-system-9 mb-6">Selecione o tipo de plano que deseja criar</p>
