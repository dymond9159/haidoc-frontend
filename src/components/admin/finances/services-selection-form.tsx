...
export function ServicesSelectionForm({ onSubmit, onBack }: ServicesSelectionFormProps) {
  ...
  const handleChange = (category: string, field: string, value: string) => {
    if (category) {
      setFormData({
        ...formData,
        [category]: {
          ...(formData[category as keyof typeof formData] as Record<string, any>),
          [field]: value,
        },
      })
    } else {
  ...
  return (
    <div>
      ...
      <div className="space-y-6">
        <h3 className="text-sm font-semibold">Selecione o número de serviços grátis disponíveis em cada modalidade</h3>
        <Accordion type="single" collapsible defaultValue="clinic" className="w-full">
          <AccordionItem value="clinic">
            <AccordionTrigger className="text-secondary-11 font-medium">Presencialmente na clínica</AccordionTrigger>
            <AccordionContent>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex">
                    <Input
                      ...
                      onChange={(e) => handleChange("clinicConsults", "normal", e.target.value)}
                    />
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex">
                    <Input
                      ...
                      onChange={(e) => handleChange("clinicConsults", "urgent", e.target.value)}
                    />
                  </div>
                  <div className="space-y-2 mt-2">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex">
                    <Input
                      ...
                      onChange={(e) => handleChange("clinicConsults", "followup", e.target.value)}
                    />
                  </div>
                  <div className="space-y-2 mt-2">
          ...
          <AccordionItem value="home">
            <AccordionTrigger className="text-secondary-11 font-medium">A domicílio</AccordionTrigger>
            <AccordionContent>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex">
                    <Input
                      ...
                      onChange={(e) => handleChange("", "homeConsults", e.target.value)}
                    />
                  </div>
                  <div className="space-y-2 mt-2">
          ...
          <AccordionItem value="teleconsult">
            <AccordionTrigger className="text-secondary-11 font-medium">Teleconsulta</AccordionTrigger>
            <AccordionContent>
              <div className="grid grid-cols-1 gap-4 pt-4">
                <div className="space-y-2">
                  ...
                  <div className="flex">
                    <Input
                      ...
                      onChange={(e) => handleChange("", "teleconsults", e.target.value)}
                    />
                  </div>
                  <div className="space-y-2 mt-2">
        ...
        <div className="space-y-4">
          <div>
            <Label className="text-sm font-medium">Selecione o número de consultas por Chat Rápido:</Label>
              ...
              <div className="space-y-2">
                ...
                <div className="flex">
                  <Input
                    ...
                    onChange={(e) => handleChange("", "chatConsults", e.target.value)}
                  />
                </div>
              </div>
              <div className="space-y-2">
          ...
          <div>
            <Label className="text-sm font-medium">Selecione os serviços disponíveis apenas para Maputo:</Label>
              ...
              <div className="space-y-2">
                ...
                <div className="flex">
                  <Input
                    ...
                    onChange={(e) => handleChange("", "preEvaluations", e.target.value)}
                  />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="flex">
                  <Input
                    ...
                    onChange={(e) => handleChange("", "medicineDelivery", e.target.value)}
                  />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="flex">
                  <Input id="home-consult-maputo" type="number" placeholder="Digite aqui" />
                </div>
              </div>
            </div>
          </div>
