        ...
        cell: (row) =>
          row?.isAccepted ? (
            ...
            <div className="flex items-center gap-1 justify-center">
              <Button variant="outline" color="success" size="icon" className="size-8 rounded-full">
                <CheckIcon />
              </Button>
              <Button variant="outline" color="error" size="icon" className="size-8 rounded-full">
                <X />
              </Button>
              <Button variant="outline" color="default" size="icon" className="size-8 rounded-full">
                <MessageSquareTextIcon />
              </Button>
              <Button variant="outline" color="info" size="icon" className="size-8 rounded-full">
                <HistoryIcon />
              </Button>
            </div>
          ),
