...
export function InactivePlanDialog({ open, onOpenChange, planId }: InactivePlanDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md p-6">
        <div className="">
          ...
          <DialogDescription>
            O plano será movido para a seção Inativos e não ficará disponível para assinatura.
          </DialogDescription>
